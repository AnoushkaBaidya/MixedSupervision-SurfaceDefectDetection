class Config:
    ...
    def init_extra(self):
        ...
        elif self.DATASET == 'YOURDATASET':
            self.INPUT_WIDTH = 256
            self.INPUT_HEIGHT = 256
            self.INPUT_CHANNELS = 3
            self.DATASET_PATH = "/Users/anoushka/Desktop/Projects/SurfaceDefectDL/MyDataset"
        
        elif self.DATASET == 'TRAININGDATASET':
            self.INPUT_WIDTH = 256
            self.INPUT_HEIGHT = 256
            self.INPUT_CHANNELS = 3
            self.DATASET_PATH = "/Users/anoushka/Desktop/Projects/SurfaceDefectDL/MyTrainDataset"
