...
# Configuration
MODEL_PATH = "/home/ubuntu/Projects/MixedSupervision-SurfaceDefectDetection/RESULTS/TRAININGDATASET/experiment_4/models/final_state_dict.pth"  # Path to the saved model
